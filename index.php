  ...
  <section class="page">
    ...
    <div class="row">
      <div class="six columns">
        <p class="to">Vice President of Talent and Culture<br/>
        Mr. Rick Avalos<br/>
        Outdoorsy<br/>
        San Francisco, CA</p><br/>
      </div><!--/col-->
      <div class="six columns">
        <p class="date">October 1st, 2019</p>
      </div><!--/col-->
    </div><!--/row-->
    <p>Dear Rik,</p>
    ...
    C.M. Kennedy</p><br/>
    <p class="ps">P.S. Don't worry if things don't work out between us, I am more than happy to transfer this domain to you free of cost.</p>
